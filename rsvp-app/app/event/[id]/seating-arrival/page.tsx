...
<head>
  <meta charset="utf-8" />
  <title>סיכום ישיבה – ${eventTitle || eventId}</title>
  <style>
...
<body>
  <h1>הושבת מוזמנים ${eventTitle ? '• ' + eventTitle : ''}</h1>
  <div class="grid">
            ...
            <tbody>
              {filteredGuests.length > 0 ? (
                filteredGuests.map((guest: any) => {
                  const confirmed = getConfirmedQty(guest) || guest.confirmedCount || guest.quantity || 1;
